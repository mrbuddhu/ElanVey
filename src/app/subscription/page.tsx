...
const benefitAccents = [
  ...
  { icon: "▲", color: "bg-ev-neon-yellow text-ev-black" },
  { icon: "●", color: "bg-ev-neon-pink text-white" },
  { icon: "★", color: "bg-ev-neon-cyan" },
  { icon: "■", color: "bg-ev-neon-yellow text-ev-black" },
];
        ...
        <div className="container-content px-5 md:px-8 lg:px-12">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {subscriptionBenefits.map((benefit, i) => {
              ...
              const textTone = accent.color.includes("text-white")
                ? "text-white"
                : "text-ev-black";
              return (
                <Reveal
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <h3 className={`pt-1 font-brutal text-base uppercase ${textTone}`}>
                      {benefit.title}
                    </h3>
                  </div>
                  <p className={`mt-4 text-sm font-bold opacity-80 ${textTone}`}>
                    {benefit.description}
                  </p>
                </Reveal>
              );
